...
// console.log(document.querySelectorAll('#birds'));
...
// const removeAnimalClass = document.querySelectorAll('animal')
//     for (let i = 0; animal.length; i++) {
//         removeAnimalClass[i].classList.remove('animal');
// };
